...
export default function DealFilters({ openFilter, onOpenFilter, onCloseFilter }) {
    const renderGender = (
        <Stack spacing={1}>
    ...
    const renderColors = (
        <Stack spacing={1}>
            ...
            <ColorPicker name="colors" selected={[]} colors={COLOR_OPTIONS} onSelectColor={(color) => [].includes(color)} sx={{ maxWidth: 38 * 4 }} />
        </Stack>
    );
